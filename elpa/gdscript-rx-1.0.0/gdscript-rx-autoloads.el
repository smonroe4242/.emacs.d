;;; gdscript-rx-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gdscript-comint" '("godot-mode" "gdscript-comint--")))
...
;;;***

;;;### (autoloads nil "gdscript-tests" "gdscript-tests.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from gdscript-tests.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gdscript-tests" '("gdscript-tests-")))
...
;; coding: utf-8
;; End:
;;; gdscript-rx-autoloads.el ends here
